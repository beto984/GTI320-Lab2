...
TEST(TestLabo1_Extra, DotAndNorm)
{
    {
        Vector3d u;
...
TEST(TestLabo1_Extra, Transpose)
{
    {
...
TEST(TestLabo1_Extra, AffectationBySubMatrix)
{
...
TEST(TestLabo1_Extra, ProductMatrixMatrix)
{
    {
...
TEST(TestLabo1_Extra, ProductMatrixVector)
{
    {
        Vector<double, 3> u;
...
TEST(TestLabo1_Extra, RigidTransformInverse)
{
    {
        Matrix<double, 4, 4, ColumnStorage> m;
